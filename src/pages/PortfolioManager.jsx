...
export default function PortfolioManager() {
  ...
  return <PageShell><section className="mx-auto max-w-[1300px] px-5 py-14 lg:px-10">
    <CreatorIdentity profile={profile} onEdit={() => setEditing(!editing)} />
