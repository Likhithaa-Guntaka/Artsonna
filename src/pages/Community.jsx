...
export default function Community(){
 ...
 {active==='boards'&&<section className="mx-auto max-w-[1500px] px-5 pb-20 lg:px-10"><h2 className="section-title mb-9">Shared boards</h2><BoardGallery/></section>}
 </PageShell>
}